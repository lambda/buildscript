...
Source: helper.dll; Flags: dontcopy
Source: README.txt; DestDir: {app}; Components: base
Source: Media\*.txt; DestDir: {app}\Media; Flags: recursesubdirs; Components: media
Source: Media2\*; DestDir: {app}\Media; Flags: recursesubdirs; Components: media
